...
% GM_central   [km3/s2]   std. grav. parameter (Gï¿½M = mu) of the central body
% 
% OUTPUT ARGUMENTS:
% ======================================================================
%   name             units   description
...
function [V1, V2, extremal_distances, exitflag] = ...
        lambert_LancasterBlanchard(r1vec, r2vec, tf, m, muC)
%{
...
function extremal_distances = ...
    ...
    if (m > 0) % obvious case (always elliptical and both apses are traversed)
        ...
        % compute theta1&2 ( use (AxB)-(CxD) = (CÂ·B)(DÂ·A) - (CÂ·A)(BÂ·D) ))
